...
ft.set_cell_prop(table, 1, ft.ANY_COLUMN, ft.CPROP_CONT_TEXT_STYLE,
                 ft.TSTYLE_BOLD)
ft.set_cell_prop(table, 9, ft.ANY_COLUMN, ft.CPROP_CONT_TEXT_STYLE,
                 ft.TSTYLE_BOLD)
ft.set_cell_prop(table, ft.ANY_ROW, 1, ft.CPROP_CONT_TEXT_STYLE, ft.TSTYLE_BOLD)
ft.set_cell_prop(table, ft.ANY_ROW, 5, ft.CPROP_CONT_TEXT_STYLE, ft.TSTYLE_BOLD)
...
ft.set_cell_prop(table, ft.ANY_ROW, 4, ft.CPROP_TEXT_ALIGN, ft.ALIGNED_RIGHT)
ft.set_cell_prop(table, ft.ANY_ROW, 5, ft.CPROP_TEXT_ALIGN, ft.ALIGNED_CENTER)
ft.set_cell_prop(table, 9, 1, ft.CPROP_TEXT_ALIGN, ft.ALIGNED_CENTER)

-- Set colors
ft.set_cell_prop(table, 2, 5, ft.CPROP_CONT_FG_COLOR, ft.COLOR_GREEN)
ft.set_cell_prop(table, 4, 5, ft.CPROP_CONT_FG_COLOR, ft.COLOR_RED)
ft.set_cell_prop(table, 7, 5, ft.CPROP_CONT_FG_COLOR, ft.COLOR_GREEN)
ft.set_cell_prop(table, 9, 5, ft.CPROP_CONT_FG_COLOR, ft.COLOR_RED)
ft.set_cell_prop(table, 4, 3, ft.CPROP_CONT_FG_COLOR, ft.COLOR_RED)
ft.set_cell_prop(table, 5, 4, ft.CPROP_CONT_BG_COLOR, ft.COLOR_LIGHT_RED)
ft.set_cell_prop(table, 1, ft.ANY_COLUMN, ft.CPROP_CONT_FG_COLOR,
                 ft.COLOR_LIGHT_BLUE)
