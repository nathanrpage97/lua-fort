...
describe("basic table data injection", function()
    ...
    it("row_write", function()
        ...
        assert.equals(fort.cur_row(simple_table), 0)
        assert.equals(fort.cur_col(simple_table), 4)
    end)
    ...
    it("row_write with ln", function()
        ...
        assert.equals(fort.cur_col(simple_table), 0)
    end)
    ...
    it("table_write", function()
        ...
        assert.equals(fort.cur_col(simple_table), 2)
    end)
...
describe("advanced table data injection", function()
    it("unaligned column table write", function()
        local adv_table = fort.create_table()
        fort.print_ln(adv_table, "0|1")
        fort.print(adv_table, "2|3")
        fort.table_write(adv_table, {{"4", "5"}, {"6", "7"}})
        assert.equals(fort.cur_row(adv_table), 2)
        assert.equals(fort.cur_col(adv_table), 2)
        assert.equals(fort.to_string(adv_table), [[
+---+---+---+---+
| 0 | 1 |   |   |
| 2 | 3 | 4 | 5 |
| 6 | 7 |   |   |
...
+---+---+---+---+
        ...
        assert.equals(fort.cur_row(adv_table), 2)
        assert.equals(fort.cur_col(adv_table), 4)
    end)
end)
...
describe("table erasing", function()
    it("erase_range cell", function()
        ...
        fort.row_write_ln(simple_table, {"hello", "test"})
        fort.row_write_ln(simple_table, {"hello", "test"})
        fort.erase_range(simple_table, 0, 0, 0, 0)
        print(fort.to_string(simple_table))
    ...
    it("erase_range row", function()
        ...
        fort.row_write_ln(simple_table, {"hello", "test"})
        fort.row_write_ln(simple_table, {"hello", "test"})
        fort.erase_range(simple_table, 0, 0, 0, 1)
        print(fort.to_string(simple_table))
    ...
    it("erase_range all", function()
        ...
        fort.row_write_ln(simple_table, {"hello", "test"})
        fort.row_write_ln(simple_table, {"hello", "test"})
        fort.erase_range(simple_table, 0, 0, 1, 1)
        print(fort.to_string(simple_table))
